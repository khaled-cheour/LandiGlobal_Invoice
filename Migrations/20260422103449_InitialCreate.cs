        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageInvoiceValue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CurrentMonthInvoices = table.Column<int>(type: "int", nullable: true),
                    CurrentMonthRevenue = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    TopCustomer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TopCustomerInvoiceCount = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipFromAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    InvalidProductCount = table.Column<int>(type: "int", nullable: false),
                    OriginalPDF = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    EnrichedPDF = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainDisplay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecondDisplay = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    HSCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MemoryPlan = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    G4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GMS = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceHistoryProducts_InvoiceHistories_InvoiceHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_CreatedAt",
                table: "InvoiceHistories",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_CustomerName",
                table: "InvoiceHistories",
                column: "CustomerName");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistories_Status",
                table: "InvoiceHistories",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceHistoryProducts_InvoiceHistoryId",
